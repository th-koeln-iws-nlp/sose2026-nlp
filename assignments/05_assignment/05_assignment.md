...
2. **Fine-tune a second BERT model.** Search [huggingface.co/models](https://huggingface.co/models) for an English encoder model of your choice. Fine-tune it on the same genre split with the same hyperparameters as task 1. Briefly explain why you picked this model.
